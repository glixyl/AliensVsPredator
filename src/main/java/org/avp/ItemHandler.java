...
public class ItemHandler extends IBHandler implements IInitializable
{
    ...
    public Item               itemWristbracerBlades       = (new HookedItem()).setDescription("Place these in the first slot of your wristbracer").setMaxStackSize(1).setMaxDurability(AliensVsPredator.materials().tools().celtic.getMaxUses());
