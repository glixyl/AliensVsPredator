...
public class ItemHandler extends IBHandler implements IInitializable
{
	...
	public Item helmXeno = (new ItemArmorXeno(AliensVsPredator.materials().armors().chitin, 4, 0)),
		...
		itemWristbracerBlades = (new HookedItem()).setDescription("Place these in the first slot of your wristbracer").setMaxStackSize(1).setMaxDurability(AliensVsPredator.materials().tools().celtic.getMaxUses()),
		...
		itemFuelTank = (new HookedItem()).setDescription("Pressurized fuel tank.").setMaxStackSize(1).setMaxDurability(64),
