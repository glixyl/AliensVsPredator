...
public class CraftingHandler implements IInitializable
{
    ...
    public void addRecipes()
    {
		...
		GameRegistry.addRecipe(new ItemStack(AliensVsPredator.blocks().blockWorkstation, 1), "aba", "dfd", "ceg", 'a', AliensVsPredator.items().itemRAM, 'b', AliensVsPredator.items().itemProcessor, 'c', AliensVsPredator.items().itemPowerSupply, 'd', AliensVsPredator.items().itemPolycarbonate, 'e', AliensVsPredator.items().itemSolidStateDrive, 'f', AliensVsPredator.items().itemLedDisplay, 'g', AliensVsPredator.items().itemMotherboard);
    ...
    public void addSchematics()
    {
        ...
        AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("medpod", Inventories.newStack(avpBlock.blockMedpod, 1), Inventories.newStack(avp.itemPolycarbonate, 4), Inventories.newStack(avp.itemIngotAluminum, 4), Inventories.newStack(avpBlock.blockIndustrialGlass, 4), Inventories.newStack(avpBlock.blockWorkstation, 1)));
		...
		// now you can make 1-way portals to Varda, Acheron and back to Earth with an assembler recipe
		AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("portalVarda", Inventories.newStack(avpBlock.blockPortalVarda, 1), Inventories.newStack(avp.itemPolycarbonate, 6), Inventories.newStack(Items.diamond, 6), Inventories.newStack(avpBlock.blockPowercell, 1), Inventories.newStack(avp.itemFlashDrive, 1)));
		AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("portalAcheron", Inventories.newStack(avpBlock.blockPortalAcheron, 1), Inventories.newStack(avp.itemPolycarbonate, 6), Inventories.newStack(Items.diamond, 6), Inventories.newStack(avpBlock.blockPowercell, 1), Inventories.newStack(avp.itemFlashDrive, 1)));
		AssemblerAPI.instance.registerSchematic(new AssemblerSchematic("powerCell", Inventories.newStack(avpBlock.blockPowercell, 1), Inventories.newStack(avp.itemPolycarbonate, 6), Inventories.newStack(Items.diamond, 6), Inventories.newStack(avpBlock.blockRepulsionGenerator, 1)));
