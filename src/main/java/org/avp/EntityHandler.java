...
public class EntityHandler implements IInitializable
{
    ...
    private void registerSpawns()
    {
        ...
        BiomeGenBase[] aquaXenomorphBiomes = new BiomeGenBase[] { BiomeGenBase.river, BiomeGenBase.beach, BiomeGenBase.stoneBeach
        };
