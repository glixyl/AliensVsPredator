...
public class ModelCrusher extends ModelBase
{
	...
	public ModelCrusher()
	{
		...
		this.ram_head_peice = new ModelRenderer(this, 5, 20);
		this.ram_head_peice.addBox(-4.0F, -3.0F, -5.0F, 8, 4, 2);
		this.ram_head_peice.setRotationPoint(0.0F, -7.5F, -2.2F);
		this.ram_head_peice.setTextureSize(256, 128);
		this.ram_head_peice.mirror = true;
		this.setRotation(this.ram_head_peice, -0.4029748F, 0.0F, 0.0F);
		this.ram_head_peice_2 = new ModelRenderer(this, 80, 53);
		this.ram_head_peice_2.addBox(-5.0F, -6.0F, -5.2F, 10, 4, 2);
		this.ram_head_peice_2.setRotationPoint(0.0F, -7.5F, -2.2F);
		this.ram_head_peice_2.setTextureSize(256, 128);
		this.ram_head_peice_2.mirror = true;
		this.setRotation(this.ram_head_peice_2, -0.5516893F, 0.0F, 0.0F);
		this.ram_head_peice_3 = new ModelRenderer(this, 80, 60);
		this.ram_head_peice_3.addBox(-5.0F, -10.0F, -6.0F, 10, 5, 2);
		this.ram_head_peice_3.setRotationPoint(0.0F, -7.5F, -2.2F);
		this.ram_head_peice_3.setTextureSize(256, 128);
		this.ram_head_peice_3.mirror = true;
		this.setRotation(this.ram_head_peice_3, -0.7004037F, 0.0F, 0.0F);
		ram_head_peice_5 = new ModelRenderer(this, 105, 57);
		ram_head_peice_5.addBox(-6F, -12F, -6F, 12, 4, 2);
		ram_head_peice_5.setRotationPoint(0F, -5.5F, -2.2F);
		ram_head_peice_5.setTextureSize(256, 128);
		ram_head_peice_5.mirror = true;
		setRotation(ram_head_peice_5, -0.8119396F, 0F, 0F);
		this.ram_head_peice_6 = new ModelRenderer(this, 134, 57);
		this.ram_head_peice_6.addBox(-7.0F, -17.0F, -5.0F, 14, 5, 2);
		this.ram_head_peice_6.setRotationPoint(0.0F, -7.5F, -2.2F);
		this.ram_head_peice_6.setTextureSize(256, 128);
		this.ram_head_peice_6.mirror = true;
		this.setRotation(this.ram_head_peice_6, -0.7375823F, 0.0F, 0.0F);
		this.ram_head_peice_7 = new ModelRenderer(this, 167, 57);
		this.ram_head_peice_7.addBox(-6.0F, -19.5F, -9.0F, 12, 4, 2);
		this.ram_head_peice_7.setRotationPoint(0.0F, -7.5F, -2.2F);
		this.ram_head_peice_7.setTextureSize(256, 128);
		this.ram_head_peice_7.mirror = true;
		this.setRotation(this.ram_head_peice_7, -0.9234754F, 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.ram_head_peice.render(f5);
		this.ram_head_peice_2.render(f5);
		this.ram_head_peice_3.render(f5);
		this.ram_head_peice_5.render(f5);
		this.ram_head_peice_6.render(f5);
		this.ram_head_peice_7.render(f5);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		this.sJaw1.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.sHead.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.sHead2.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.sHead2.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.sHead4.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.ram_head_peice_7.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.ram_head_peice.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.ram_head_peice_2.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.ram_head_peice_3.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.ram_head_peice_5.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
		this.ram_head_peice_6.rotateAngleY = (float) Math.toRadians((double) f3) * 0.75F;
