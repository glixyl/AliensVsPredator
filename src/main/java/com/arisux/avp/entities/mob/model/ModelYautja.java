...
public class ModelYautja extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.head27.render(f5);
		this.head28.render(f5);
		this.head29.render(f5);
		this.head30.render(f5);
		this.head31.render(f5);
		this.head32.render(f5);
		this.head33.render(f5);
		this.head34.render(f5);
		this.head35.render(f5);
		this.head36.render(f5);
		this.head37.render(f5);
		this.head38.render(f5);
		this.head39.render(f5);
		this.head40.render(f5);
		this.head41.render(f5);
		this.head42.render(f5);
		this.head43.render(f5);
		this.head44.render(f5);
		this.head45.render(f5);
		this.head46.render(f5);
		this.head47.render(f5);
		this.head48.render(f5);
		this.head49.render(f5);
		this.head50.render(f5);
		this.head51.render(f5);
		this.head52.render(f5);
