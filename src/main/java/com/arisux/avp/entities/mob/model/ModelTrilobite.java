...
public class ModelTrilobite extends ModelBaseExtension
{
	...
	{
		this.TailGrossTenticle.render(f5);
		this.RMiddleTenticle2.render(f5);
		this.RFrontPetal_1.render(f5);
		this.RMiddleTenticle3.render(f5);
		this.LMiddlePetal.render(f5);
		this.RBackClaw.render(f5);
		this.LMiddleTenticle3.render(f5);
		this.LMiddleGrossTenticle.render(f5);
		this.Tail4.render(f5);
		this.LBackTenticle5.render(f5);
		this.Shape3.render(f5);
		this.RMiddleClaw.render(f5);
		this.RFrontTenticle5.render(f5);
		this.RMiddleTenticle4.render(f5);
		this.RBackTenticle1.render(f5);
		this.RBackPetal.render(f5);
		this.Ovipositor.render(f5);
		this.Tail3.render(f5);
		this.RFrontTenticle3.render(f5);
		this.RBackTenticle4.render(f5);
		this.LFrontTenticle1.render(f5);
		this.LFrontTenticle4.render(f5);
		this.TailPetal.render(f5);
		this.LMiddleTenticle2.render(f5);
		this.RFrontTenticle2.render(f5);
		this.LMiddleTenticle5.render(f5);
		this.LMiddleTenticle1.render(f5);
		this.LFrontTenticle5.render(f5);
		this.Tail2.render(f5);
		this.LFrontTenticle2.render(f5);
		this.LFrontClaw.render(f5);
		this.LBackTenticle2.render(f5);
		this.RBackTenticle2.render(f5);
		this.LFrontGrossTenticle.render(f5);
		this.RMiddleGrossTenticle.render(f5);
		this.RMiddlePetal.render(f5);
		this.TailClaw.render(f5);
		this.RFrontGrossTenticle.render(f5);
		this.LBackGrossTenticle_1.render(f5);
		this.LJaw.render(f5);
		this.LBackTenticle3.render(f5);
		this.LBackGrossTenticle.render(f5);
		this.LBackPetal.render(f5);
		this.LBackClaw.render(f5);
		this.LMiddleTenticle4.render(f5);
		this.RFrontTenticle5_1.render(f5);
		this.RFrontTenticle4.render(f5);
		this.RBackTenticle5.render(f5);
		this.RBackTenticle3.render(f5);
		this.LFrontTenticle3.render(f5);
		this.LBackTneticle1.render(f5);
		this.RFrontPetal.render(f5);
		this.RFrontClaw.render(f5);
		this.Tail5.render(f5);
		this.RFrontTenticle1.render(f5);
		this.Tail.render(f5);
		this.LMiddleClaw.render(f5);
		this.LBackTenticle4.render(f5);
		this.RJaw.render(f5);
		this.RMiddleTenticle1.render(f5);
		this.Body.render(f5);
	}
}
