	...
	public void doRender(Entity entity, double posX, double posY, double posZ, float yaw, float renderPartialTicks)
	{
		...
		GL11.glPushMatrix();
		{
			...
			GL11.glPushMatrix();
			{
				...
				this.model.render(0.6F, 0.45F, 0.45F, 0.5F, 0.7F);
				
				GL11.glPushMatrix();
				{
					GL11.glRotatef(rotation, 0.0F, 1.0F, 0.0F);
					this.model.render(0.7F, 0.45F, 0.45F, 0.5F, 0.7F);
					
					GL11.glPushMatrix();
					{
						GL11.glRotatef(rotation, 0.0F, 1.0F, 0.0F);
						this.model.render(0.8F, 0.45F, 0.45F, 0.5F, 0.7F);
						
						GL11.glPushMatrix();
						{
							GL11.glRotatef(rotation, 0.0F, 1.0F, 0.0F);
							this.model.render(0.9F, 0.45F, 0.45F, 0.5F, 0.7F);
							
							GL11.glPushMatrix();
							{
								GL11.glRotatef(rotation, 0.0F, 1.0F, 0.0F);
								this.model.render(1.0F, 0.45F, 0.45F, 0.5F, 0.7F);
							}
							GL11.glPopMatrix();
						}
						GL11.glPopMatrix();
