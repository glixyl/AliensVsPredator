...
public class RenderBullet extends Render
{
	...
	{
		this.renderBoat((EntityBullet) entity, d, d1, d2, f, f1);
	}

	public void renderBoat(EntityBullet entity, double d, double d1, double d2, float f, float f1)
	{
		GL11.glPushMatrix();
	...
	private void lightingHelper(EntityBullet entity, float f, float f1)
	{
