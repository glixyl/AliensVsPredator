...
public class TeleporterVarda extends Teleporter
{
	...
	public boolean placeInExistingPortal(Entity var1, double var2, double var4, double var6, float var8)
	{
		...
		if (this.destinationCoordinateCache.containsItem(var17))
		{
			...
			var13 = var26.posY;
			var14 = var26.posZ;
			var26.lastUpdateTime = this.worldServerInstance.getTotalWorldTime();
			var19 = false;
		} else
		{
			for (int var22 = var15 - var9; var22 <= var15 + var9; var22++)
			{
				double var24 = var22 + 0.5D - var1.posX;

				for (int var46 = var16 - var9; var46 <= var16 + var9; var46++)
				{
					double var27 = var46 + 0.5D - var1.posZ;
					...
					for (int var23 = this.worldServerInstance.getActualHeight() - 1; var23 >= 0; var23--)
					{
						...
						double var20 = var23 + 0.5D - var1.posY;
		...
		if (var10 >= 0.0D)
		{
			...
			int var23 = var1.getMaxSafePointTries();
			...
			if (var28 > -1)
			{
				...
				var1.motionX = (var42 * var38 + var44 * var41);
				var1.motionZ = (var42 * var40 + var44 * var39);
				var1.rotationYaw = (var8 - var23 * 90 + var28 * 90);
			} else
			{
				var1.motionX = (var1.motionY = var1.motionZ = 0.0D);
			}

			var1.setLocationAndAngles(var24, var47, var20, var1.rotationYaw, var1.rotationPitch);
			return true;
		}
	...
	public boolean makePortal(Entity var1)
	{
		...
		for (int var13 = var5 - var2; var13 <= var5 + var2; var13++)
		{
			...
			for (int var19 = var7 - var2; var19 <= var7 + var2; var19++)
			{
				...
				label430: for (int var18 = this.worldServerInstance.getActualHeight() - 1; var18 >= 0; var18--)
				{
					if (!this.worldServerInstance.isAirBlock(var13, var18, var19))
						continue;
					while ((var18 > 0) && (this.worldServerInstance.isAirBlock(var13, var18 - 1, var19)))
					{
						var18--;
					}
						...
						for (int var23 = 0; var23 < 3; var23++)
						{
							for (int var24 = 0; var24 < 4; var24++)
							{
								for (int var25 = -1; var25 < 4; var25++)
								{
									...
									if (((var25 < 0) && (!this.worldServerInstance.getBlock(var26, var27, var32).getMaterial().isSolid())) || ((var25 >= 0) && (!this.worldServerInstance.isAirBlock(var26, var27, var32))))
									{
										break label430;
									}
								}
		...
		if (var3 < 0.0D)
		{
			for (int var13 = var5 - var2; var13 <= var5 + var2; var13++)
			{
				...
				for (int var19 = var7 - var2; var19 <= var7 + var2; var19++)
				{
					...
					label780: for (int var18 = this.worldServerInstance.getActualHeight() - 1; var18 >= 0; var18--)
					{
						if (!this.worldServerInstance.isAirBlock(var13, var18, var19))
							continue;
						while ((var18 > 0) && (this.worldServerInstance.isAirBlock(var13, var18 - 1, var19)))
