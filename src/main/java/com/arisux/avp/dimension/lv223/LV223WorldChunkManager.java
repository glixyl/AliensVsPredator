...
public class LV223WorldChunkManager extends WorldChunkManager
{
	private BiomeGenBase biomeGenerator;
	private float hellTemperature;
	private float rainfall;

	public LV223WorldChunkManager(BiomeGenBase var1)
	{
	...
	{
		return loadBlockGeneratorData(var1, var2, var3, var4, var5);
	}
