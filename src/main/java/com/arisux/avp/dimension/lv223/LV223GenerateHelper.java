...
public abstract class LV223GenerateHelper extends WorldGenerator
{
	protected StructureBoundingBox boundingBox;
	protected int coordBaseMode;
	protected int componentType;

	protected LV223GenerateHelper(int var1)
	{
	...
	public static LV223GenerateHelper findIntersecting(List<LV223GenerateHelper> var0, StructureBoundingBox var1)
	{
		Iterator<LV223GenerateHelper> var2 = var0.iterator();
		LV223GenerateHelper var3;
		...
		do
		{
			...
			var3 = (LV223GenerateHelper) var2.next();
		}
