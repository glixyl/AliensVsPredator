...
public class ItemHandler extends IBHandler implements IInitializable
{
	...
	public Item helmXeno = (new ItemArmorXeno(XENO, 4, 0)),
		...
		itemAmmoPistol = ((HookedItem) (new ItemAmmo(0.5F))).setDescription("A magazine classified for use with pistols."),
		itemAmmoAR = ((HookedItem) (new ItemAmmo(1.0F))).setDescription("A magazine classified for use with assault rifles."),
		itemAmmoAC = ((HookedItem) (new ItemAmmo(1.5F))).setDescription("A magazine classified for use with assault carbines."),
		itemAmmoSMG = ((HookedItem) (new ItemAmmo(2.5F))).setDescription("A magazine classified for use with sub machine-guns."),
		itemAmmoSniper = ((HookedItem) (new ItemAmmo(15.0F))).setDescription("A magazine classified for use with sniper rifles."),
