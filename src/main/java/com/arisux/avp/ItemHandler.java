...
public class ItemHandler extends IBHandler implements IInitializable
{
	...
	public Item helmXeno = (new ItemArmorXeno(XENO, 4, 0)),
		...
		itemArtifactTech = (new HookedItem()).setDescription("An unknown piece of technology aquired from the yautja species.").setMaxStackSize(64),
		itemProcessor = ((new HookedItem())),
		itemSolidStateDrive = ((new HookedItem())),
		itemDiode = (new HookedItem()).setMaxStackSize(64),
		...
		itemVoltageRegulator = (new HookedItem()).setMaxStackSize(64),
