...
public class RenderM4 extends ItemRenderer3D
{
	...
	public void renderThirdPerson(ItemStack item, Object... data)
	{
		...
		this.resource = RenderEngine.downloadResource(String.format(AliensVsPredator.properties().URL_SKIN_M4, player.getUUID()), resourceLocation);

		if (player != null)
		{
			Minecraft.getMinecraft().renderEngine.bindTexture(RenderEngine.downloadResource(String.format(AliensVsPredator.properties().URL_SKIN_M4, player.getUUID()), resourceLocation, false));
	...
	public void renderFirstPerson(ItemStack item, Object... data)
	{
		...
		this.resource = RenderEngine.downloadResource(String.format(AliensVsPredator.properties().URL_SKIN_M4, Minecraft.getMinecraft().session.getPlayerID()), resourceLocation);
