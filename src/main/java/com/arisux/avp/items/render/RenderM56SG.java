...
{
	public static final ResourceLocation resourceLocation = new ResourceLocation(AliensVsPredator.INSTANCE.properties.TEXTURE_PATH_M56SG);
	...
	public void renderFirstPerson(ItemStack item, Object... data)
	{
		...
		this.resource = RenderLib.downloadResource(String.format(AliensVsPredator.INSTANCE.properties.URL_SKIN_M56SG, Minecraft.getMinecraft().session.getPlayerID()), resourceLocation);
	...
	public void renderThirdPerson(ItemStack item, Object... data)
	{
		...
		this.resource = RenderLib.downloadResource(String.format(AliensVsPredator.INSTANCE.properties.URL_SKIN_M56SG, player.getUUID()), resourceLocation);

		if (player != null)
		{
			Minecraft.getMinecraft().renderEngine.bindTexture(RenderLib.downloadResource(String.format(AliensVsPredator.INSTANCE.properties.URL_SKIN_M56SG, player.getUUID()), resourceLocation, false));
