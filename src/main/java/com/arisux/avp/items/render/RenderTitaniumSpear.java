...
{
	private static final ResourceLocation resourceLocation = new ResourceLocation(AliensVsPredator.INSTANCE.properties.TEXTURE_PATH_SPEAR);
	...
	public void renderArrow(EntitySpear var1, double var2, double var4, double var6, float var8, float var9)
	{
		if (var1.prevRotationYaw != 0.0F || var1.prevRotationPitch != 0.0F)
		{
			...
			for (int var231 = 0; var231 < 4; ++var231)
			{
				...
				var10.startDrawingQuads();
				var10.addVertexWithUV(-20.0D, -2.0D, 0.0D, (double) var12, (double) var14);
				var10.addVertexWithUV(20.0D, -2.0D, 0.0D, (double) var13, (double) var14);
				var10.addVertexWithUV(20.0D, 2.0D, 0.0D, (double) var13, (double) var15);
				var10.addVertexWithUV(-20.0D, 2.0D, 0.0D, (double) var12, (double) var15);
				var10.draw();
			}
