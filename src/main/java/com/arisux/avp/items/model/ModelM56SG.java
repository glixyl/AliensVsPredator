...
public class ModelM56SG extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.base.render(f5);
		this.ammoHolder.render(f5);
		this.handleWire.render(f5);
		this.autoTargetEye.render(f5);
		this.baseUnder.render(f5);
		this.topHandle.render(f5);
		this.topHandleBase.render(f5);
		this.barrelHolderBase.render(f5);
		this.barrelSupportLeft.render(f5);
		this.barrelSupportRight.render(f5);
		this.autoTargetControl.render(f5);
		this.barrel.render(f5);
		this.handle.render(f5);
		this.base2.render(f5);
		this.base3.render(f5);
		this.baseUnder2.render(f5);
		this.handleTop.render(f5);
		this.topHandleBase2.render(f5);
	}
