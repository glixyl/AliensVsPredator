...
public class BlockHandler extends IBHandler implements IInitializable
{
	public Block terrainHiveResin = (new BlockHiveResin(Material.wood)).setHardness(0.1F).setLightOpacity(255),
		...
		blockWall = (new HookedBlock(Material.iron)).setHardness(5F).setResistance(30.0F),
		blockWallW = (new HookedBlock(Material.iron).setIconSet(new IconSet(this.getMod().domain() + "wall_top", this.getMod().domain() + "wall_top", this.getMod().domain() + "wall_top", this.getMod().domain() + "wall_side", this.getMod().domain() + "wall_side", this.getMod().domain() + "wall_side", this.getMod().domain() + "wall_side"))).setHardness(5F).setResistance(30.0F),
		...
		blockIronBricksStairs = (new HookedBlockStairs(blockIronBricks)).setHardness(5F).setResistance(30.0F),
		blockWallStairs = (new HookedBlockStairs(blockWall)).setHardness(5F).setResistance(30.0F),
		blockWallSlab = (new HookedBlockSlab(Material.iron)).setHardness(5F).setResistance(30.0F),
		blockIronBricksSlab = (new HookedBlockSlab(Material.iron)).setHardness(5F).setResistance(30.0F),
