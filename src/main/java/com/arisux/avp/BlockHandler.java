...
public class BlockHandler extends IBHandler implements IInitializable
{
	...
	public void registerShapedBlockSet(Block block, String reference, Block blockParent)
	{
		if (block instanceof HookedBlock)
		{
			...
			HookedBlock blockSlope = ((HookedBlock) (new BlockShape(blockBaseHook.getMaterial(), ShapeTypes.SLOPE)).setIconSet(blockParentHook.getIconSet()).setHardness(blockBaseHook.blockHardness).setLightOpacity(blockBaseHook.getLightOpacity())).setRenderNormal(blockBaseHook.renderAsNormalBlock()).setOpaque(blockBaseHook.isOpaqueCube());
			HookedBlock blockCorner = ((HookedBlock) (new BlockShape(blockBaseHook.getMaterial(), ShapeTypes.CORNER)).setIconSet(blockParentHook.getIconSet()).setHardness(blockBaseHook.blockHardness).setLightOpacity(blockBaseHook.getLightOpacity())).setRenderNormal(blockBaseHook.renderAsNormalBlock()).setOpaque(blockBaseHook.isOpaqueCube());
			HookedBlock blockInvertedCorner = ((HookedBlock) (new BlockShape(blockBaseHook.getMaterial(), ShapeTypes.INVERTED_CORNER)).setIconSet(blockParentHook.getIconSet()).setHardness(blockBaseHook.blockHardness).setLightOpacity(blockBaseHook.getLightOpacity())).setRenderNormal(blockBaseHook.renderAsNormalBlock()).setOpaque(blockBaseHook.isOpaqueCube());
			HookedBlock blockRidge = ((HookedBlock) (new BlockShape(blockBaseHook.getMaterial(), ShapeTypes.RIDGE)).setIconSet(blockParentHook.getIconSet()).setHardness(blockBaseHook.blockHardness).setLightOpacity(blockBaseHook.getLightOpacity())).setRenderNormal(blockBaseHook.renderAsNormalBlock()).setOpaque(blockBaseHook.isOpaqueCube());
			HookedBlock blockInvertedRidge = ((HookedBlock) (new BlockShape(blockBaseHook.getMaterial(), ShapeTypes.INVERTED_RIDGE)).setIconSet(blockParentHook.getIconSet()).setHardness(blockBaseHook.blockHardness).setLightOpacity(blockBaseHook.getLightOpacity())).setRenderNormal(blockBaseHook.renderAsNormalBlock()).setOpaque(blockBaseHook.isOpaqueCube());
			HookedBlock blockSmartInvertedRidge = ((HookedBlock) (new BlockShape(blockBaseHook.getMaterial(), ShapeTypes.SMART_INVERTED_RIDGE)).setIconSet(blockParentHook.getIconSet()).setHardness(blockBaseHook.blockHardness).setLightOpacity(blockBaseHook.getLightOpacity())).setRenderNormal(blockBaseHook.renderAsNormalBlock()).setOpaque(blockBaseHook.isOpaqueCube());
			HookedBlock blockSmartRidge = ((HookedBlock) (new BlockShape(blockBaseHook.getMaterial(), ShapeTypes.SMART_RIDGE)).setIconSet(blockParentHook.getIconSet()).setHardness(blockBaseHook.blockHardness).setLightOpacity(blockBaseHook.getLightOpacity())).setRenderNormal(blockBaseHook.renderAsNormalBlock()).setOpaque(blockBaseHook.isOpaqueCube());
